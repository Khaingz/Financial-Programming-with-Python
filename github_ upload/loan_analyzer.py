...
if present_value >= cost:
    print("Present value is worth at least the cost to buy it.")
else:
...
new_remaing_months = new_loan.get("remaining_months")
new_annual_discount_rate = 0.2
new_present_value = calculate_present_value(new_future_value,new_remaing_months,new_annual_discount_rate)
print(f"Present value is ${new_present_value: .2f}")  
...
# YOUR CODE HERE!
print(f"The inexpensive loans list is {inexpensive_loans}")
